...
**************************/
		var installPath = "/js/install_lodop";
        var strHtmInstall="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='" + installPath + "32.exe' target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
        var strHtmUpdate="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='" + installPath + "32.exe' target='_self'>执行升级</a>,升级后请重新进入。</font>";
        var strHtm64_Install="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='" + installPath + "64.exe' target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
        var strHtm64_Update="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='" + installPath + "64.exe' target='_self'>执行升级</a>,升级后请重新进入。</font>";
	...
	try{		     
		...
		if (navigator.userAgent.indexOf('Win64')>=0){
	     ...
	     //=====如下空白位置适合调用统一功能:=====	     
		 LODOP.SET_LICENSES("北京禾唐科技有限公司","653597369718688748719056235623","","");
	     //=======================================
	     return LODOP; 
	}catch(err){
		if (navigator.userAgent.indexOf('Win64')>=0)	
