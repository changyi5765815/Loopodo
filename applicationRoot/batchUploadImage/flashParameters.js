...
var flashOptions = {
    createOptions: {
        ...
        url: '/batchUploadImage/imageUploader.swf', //这个就是附件里面的FLASH
        width: '720', //容器宽度
        height: '272', //容器高度
        ...
        vars: {
            ...
            compressLength: 7000, // 能接受的最大边长，超过该值Flash会自动等比压缩
            url: '/batchUploadImageUrl', // 上传处理页面的url地址
            ext: '', //可向服务器提交的自定义参数列表
...
function initFlash() {
	flashObj = null;
	flashObj = new baidu.flash.imageUploader(flashOptions);
}