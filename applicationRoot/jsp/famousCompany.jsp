...
<div class="headDiv">
	<div class="btn_t left"><a href="javascript:postModuleAndAction('famousCompany','defaultView')"><span><strong>名企管理</strong></span></a></div>
	<% if (JSPDataBean.getFormData("action").equals("list")) { %>
		<div class="tip gray9" style="float: right;"><a href="javascript:openInfoWindow('famousCompany', 'selectCompanyUserWindow')" class="btn_y"><span><strong class="icon_add">添加</strong></span></a> </div>
	<% } %>
</div>
...
<div class="main clear">
    ...
    <div class="search">
	  	<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td>
					会员ID：<input type="text" name="q_userID" id="q_userID" value="<%= JSPDataBean.getFormData("q_userID") %>" size="15" maxlength="20" onkeydown="javascript:if(event.keyCode==13) postModuleAndAction('famousCompany', 'search')"/>&nbsp;
					公司名称：<input type="text" name="q_companyName" id="q_companyName" value="<%= JSPDataBean.getFormData("q_companyName") %>" size="15" maxlength="20" onkeydown="javascript:if(event.keyCode==13) postModuleAndAction('famousCompany', 'search')"/>&nbsp;
				</td>
				<td class="righttd">
					<div><dl>
	               		<dt style="width: 100%;">
	                   		<a class="btn_y" onclick="javascript:postModuleAndAction('famousCompany', 'search')"><span>搜&nbsp;&nbsp;&nbsp;&nbsp;索</span></a>
	                   	</dt>
	              	</dl></div>
				</td>
			</tr>
	...
	<div>
		<table class="list" border="0" cellpadding="0" cellspacing="1" width="100%" id="tab1">
			<tr>
				...
				<th width="7%">公司行业</th>
				<th width="7%">公司性质</th>
				<th width="8%">排序&nbsp;<input class="btn btn-xs btn-warning" value="更新" onclick="$('#table').val('user');$('#sortIndexColumnName').val('famousSortIndex');doAction('updateSortIndexAll')" type="button"></th>
				<th width="15%">操作</th>
			</tr>
			<%
			...
			<tr>
				...
				<td>
					<input id="sortIndex_<%= data.get("userID") %>" name="sortIndex_<%= data.get("userID") %>" value="<%= data.get("famousSortIndex") %>" size="5" maxlength="11" type="text">
				</td>
				<td>
					<a href="javascript:document.getElementById('userID').value='<%= data.get("userID") %>';postModuleAndAction('famousCompany', 'delete')">删除</a>
				</td>
			</tr>
			<%	} %>
		</table>
	...
	%>
		<div class="order_detail_box" style="margin: 10px;">
			...
			<div align="center">
				<div class="button">
					<a onclick="javascript:postModuleAndAction('famousCompany','defaultView')" class="btn_bb1"><span>返 回</span></a>
				</div>
			</div>
