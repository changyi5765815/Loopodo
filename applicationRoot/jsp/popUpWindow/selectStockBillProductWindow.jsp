		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td style="padding-left: 20px;">
					...
					<span>分类：</span><sapn><%= JSPDataBean.getFormData("queryProductTypeSelect3") %></span>
				</td>
				<td align="right" style="padding-right: 20px;">
					<input style="width: 80px;" type="button" class="input-button" value="搜索" onclick="javascript:$('#windowPageIndex').val('1');$('#selectedValues').val('');openInfoWindow('stockInBill', 'selectStockBillProductWindow')" />
				</td>
			</tr>
		</table>
	</div>
	...
	<div style="height:350px;overflow-y:scroll;margin-top:10px">
		<table cellpadding="0" cellspacing="0" width="99%">
			<tr style="height:30px;">
				<td width="5%" align="center"  style="border-bottom:1px solid #b8d4e8;border-top:1px solid #b8d4e8;"></td>
				<td align="center" width="10%" style="border-bottom:1px solid #b8d4e8;border-top:1px solid #b8d4e8;"><b>商品ID</b></td>
				<td align="center" width="10%" style="border-bottom:1px solid #b8d4e8;border-top:1px solid #b8d4e8;"><b>名称</b></td>
				<td align="center" width="10%" style="border-bottom:1px solid #b8d4e8;border-top:1px solid #b8d4e8;"><b>sku名称</b></td>
				<td align="center" width="15%" style="border-bottom:1px solid #b8d4e8;border-top:1px solid #b8d4e8;"><b>价格</b></td>
			</tr>
			<%
			...
			<tr>
				<td align="center"  style="border-bottom:1px solid #b8d4e8;">
					<input type="checkbox" <%= selectedValues.indexOf("," + skuID + ",") != -1 ? "checked=\"checked\"" : "" %> name="selectChoice" onchange="selectValue(this, 'selectChoice', 'selectedValues')" value="<%= skuID %>" />
				</td>
				<td align="center" style="border-bottom:1px solid #b8d4e8;"><%= data.get("productID") %></td>
				<td align="center" style="border-bottom:1px solid #b8d4e8;" title="<%= data.get("name") %>"><%= AppUtil.splitString(data.get("name").toString(), 30) %></td>
				<td align="center" style="border-bottom:1px solid #b8d4e8;"><%= skuPropName %></td>
				<td align="center" style="border-bottom:1px solid #b8d4e8;">￥<%= data.get("price") %></td>
			</tr>
			<%	} %>
		</table>
	</div>
