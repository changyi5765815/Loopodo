		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				...
				<td align="right" style="padding-right: 20px;">
					<input style="width: 80px;" type="button" class="input-button" value="搜索" onclick="javascript:document.getElementById('pageIndex').value=1;openInfoWindow('selectProductOfDiscountWindow')" />
				</td>
			</tr>
		</table>
	</div>
