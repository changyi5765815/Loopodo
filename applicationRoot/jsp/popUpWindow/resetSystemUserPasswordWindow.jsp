...
<div style="width:400px; padding:10px">
	...
	<tr>
		...
		<td width="75%"><input type="password" maxlength="20" name="password" id="password" value="" />(6-20个英文字符)<span>例：_、a~z、A~Z、0~9等</span></td>
	</tr>
	<tr>
...
<div style="text-align: center;" class="buttonsDIV">
	<a class="btn_y" onclick="javascript:doAction('resetSystemUserPassword');"><span>确认</span></a>&nbsp;
