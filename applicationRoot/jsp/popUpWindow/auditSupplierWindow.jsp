...
<div id="popwindow">
<h2><span>商户审核</span><a style="" class="close-button" href="javascript:closeInfoWindow('infoWindow');">关闭</a></h2>
<div style="width:420px; padding:10px">
	<div style="margin-top:10px;height:auto;">
		...
		<div>
			...
			<a class="btn_y" onclick="doAction('userStore', 'auditSupplier')"><span>确认</span></a>&nbsp;
