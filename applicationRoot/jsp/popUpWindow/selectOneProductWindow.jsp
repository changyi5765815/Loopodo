		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				...
				<td align="right" style="padding-right: 20px;">
					<input style="width: 80px;" type="button" class="input-button" value="搜索" onclick="javascript:document.getElementById('pageIndex').value=1;openInfoWindow('selectOneProductWindow')" />
				</td>
			</tr>
		</table>
	</div>
	...
	<div style="height:350px;overflow-y:scroll;margin-top:10px">
		<table cellpadding="0" cellspacing="0" width="99%">
			<tr style="height:30px;">
				...
				<td align="center" width="20%" style="border-bottom:1px solid #b8d4e8;border-top:1px solid #b8d4e8;"><b>名称</b></td>
				<td align="center" width="10%" style="border-bottom:1px solid #b8d4e8;border-top:1px solid #b8d4e8;"><b>分类</b></td>
				<th align="center" width="*" style="border-bottom:1px solid #b8d4e8;border-top:1px solid #b8d4e8;">价格</th>
			</tr>
			<%
			...
			<tr>
				<td align="center"  style="border-bottom:1px solid #b8d4e8;">
					<input type="radio" name="selectChoice" value="<%= data.get("productID") %>" />
				</td>
				...
				<td align="center" style="border-bottom:1px solid #b8d4e8;" id="window_product_name_<%= data.get("productID") %>"><%= data.get("name") %></td>
				<td align="center" style="border-bottom:1px solid #b8d4e8;">
					<%= data.get("bigTypeName") %> - <%= data.get("smallTypeName") %> - <%= data.get("tinyTypeName") %>
				</td>
				<td align="center" style="border-bottom:1px solid #b8d4e8;" id="window_product_price_<%= data.get("productID") %>"><%= data.get("price") %></td>
			</tr>
			<%	} %>
		</table>
	</div>
...
<div style="text-align: center;" class="buttonsDIV">
	...
	<input value="选定" class="button" style="width: 50px;height: 25px;" type="button" onclick="javascript:selectProduct()">
