		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td style="padding-left: 20px;">
					<span>品牌ID：</span><sapn><input type="text" name="q_brandID" id="q_brandID" value="<%= JSPDataBean.getFormData("q_brandID") %>" size="5" maxlength="20" /></span>&nbsp;
				...
				<td align="right" style="padding-right: 20px;">
					<input style="width: 80px;" type="button" class="input-button" value="搜索" onclick="javascript:document.getElementById('pageIndex').value=1;openInfoWindow('selectBrandWindow')" />
				</td>
			</tr>
		</table>
	</div>
	...
	<div style="height:350px;overflow-y:scroll;margin-top:10px">
		<table cellpadding="0" cellspacing="0" width="99%">
			<tr style="height:30px;">
				...
				<td align="center" width="15%" style="border-bottom:1px solid #b8d4e8;border-top:1px solid #b8d4e8;"><b>品牌ID</b></td>
			...
			<%
				Vector datas = (Vector) JSPDataBean.getJSPData("brandDatas");
			...
			<tr>
				<td align="center"  style="border-bottom:1px solid #b8d4e8;">
					<input type="radio" name="selectChoice" value="<%= data.get("brandID") %>" onclick="setSelectedValues('selectChoice', 'selectedValues')"/>
				</td>
				<td align="center" style="border-bottom:1px solid #b8d4e8;"><%= data.get("brandID") %></td>
				<td align="center" style="border-bottom:1px solid #b8d4e8;">
					<img src="<%= AppUtil.getImageURL("brand", data.get("image").toString(), 0) %>"  style="height: 60px; width: 55px; display: block;">
				</td>
...
<div style="text-align: center;" class="buttonsDIV">
	...
	<input value="选定" class="button" style="width: 50px;height: 25px;" type="button" onclick="javascript:selectBrand()">
